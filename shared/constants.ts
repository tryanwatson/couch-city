...
export const TROOP_TYPES: readonly TroopType[] = ['warrior', 'cavalry', 'rifleman', 'truck'] as const;
...
export const TRAINING_CONFIG: Record<TroopType, { food: number; gold: number; troops: number }> = {
